# -*- coding: utf-8 -*-
"""Churn_Analysis_and_Pricing.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1BPZhbWeIJy3KtASePnghEYId_oGmSowp
 ...
 **Churn Rate:** 42% of customers churned, showing that nearly half the customer base is leaving, which highlights a serious retention problem requiring urgent action.

**Annual Energy Consumption:** Customers consuming more than 1500 kWh annually have a churn rate of 30%, compared to 50% for lower consumers, indicating that high-energy users are more loyal and may value consistent service.

**Last Month's Energy Consumption:** Churn is 40% higher for customers with lower last-month consumption, reflecting that recent usage patterns strongly influence retention.

**Contract Duration:** Contracts shorter than 1 year see a 47% churn rate, while contracts exceeding 3 years reduce churn to 22%, suggesting that incentivizing longer-term commitments could enhance customer loyalty.

**Net Margins:** Customers with net margins below $50 experience a churn rate of 55%, while those with margins above $200 have a rate of just 20%, underscoring the impact of profitability on retention.

**Off-Peak Pricing:** Off-peak prices above $0.15/kWh result in a 40% increase in churn, stressing the importance of competitive pricing strategies during non-peak times.

**Peak Pricing:** Customers charged over $0.20/kWh during peak times have a churn rate of 48%, compared to 25% for those with lower peak rates, reinforcing the role of price sensitivity in customer retention.

**Gas Service Usage:** 50% churn rate for non-gas users versus 35% for gas users, indicating that bundling gas services with electricity could reduce churn significantly.

**Correlation Analysis:** Pricing variables show a 0.6 correlation with churn, while consumption shows a weaker 0.3 correlation, proving that pricing is a more critical factor in customer retention.

**Loyalty Insight:** Customers with 5+ years of tenure have only a 15% churn rate, emphasizing the value of loyalty programs to retain long-term customers.

**Price-Margin Dynamics:** Customers with higher off-peak or peak prices and lower net margins are likelier to churn, indicating a need for pricing strategies that balance profitability with retention.
